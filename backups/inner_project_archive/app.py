...
# Use CSV files located next to this script so app works regardless of CWD
USER_FILE = os.path.join(BASE_DIR, 'users.csv')
ALUMNI_FILE = os.path.join(BASE_DIR, 'alumni_dataset.csv')
...
def register():
    if request.method == 'POST':
        ...
        # defensive read: check file exists and use .get on CSV rows
